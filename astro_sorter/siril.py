...
def generate_siril_script(output_path: Path, lights_dir: Path, darks_dir: Optional[Path] = None, flats_dir: Optional[Path] = None, biases_dir: Optional[Path] = None, result_name: str = "result_stacked", method: str = "rej", rej_params: str = "3 3") -> Path:
